#[doc = "Reader of register HYS1"]
pub type R = crate::R<u16, super::HYS1>;
#[doc = "Writer for register HYS1"]
pub type W = crate::W<u16, super::HYS1>;
#[doc = "Register HYS1 `reset()`'s with value 0"]
impl crate::ResetValue for super::HYS1 {
    type Type = u16;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:8 - Hysteresis Value for Channel 1"]
    #[inline(always)]
    pub fn value(&self) -> VALUE_R {
        VALUE_R::new((self.bits & 0x01ff) as u16)
    }
    #[doc = "Bits 12:14 - Number of Conversion Cycles to Monitor Channel 1"]
    #[inline(always)]
    pub fn moncyc(&self) -> MONCYC_R {
        MONCYC_R::new(((self.bits >> 12) & 0x07) as u8)
    }
    #[doc = "Bit 15 - Enable Hysteresis for Comparison on Channel 1"]
    #[inline(always)]
    pub fn en(&self) -> EN_R {
