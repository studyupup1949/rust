#[doc = "Reader of register OVF"]
pub type R = crate::R<u16, super::OVF>;
#[doc = "Writer for register OVF"]
pub type W = crate::W<u16, super::OVF>;
#[doc = "Register OVF `reset()`'s with value 0"]
impl crate::ResetValue for super::OVF {
    type Type = u16;
    #[inline(always)]
