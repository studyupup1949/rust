#[doc = "Reader of register TONEB"]
pub type R = crate::R<u16, super::TONEB>;
#[doc = "Writer for register TONEB"]
pub type W = crate::W<u16, super::TONEB>;
#[doc = "Register TONEB `reset()`'s with value 0x01"]
impl crate::ResetValue for super::TONEB {
    type Type = u16;
    #[inline(always)]
