#[doc = "Reader of register CNVT_B"]
pub type R = crate::R<u32, super::CNVT_B>;
#[doc = "Writer for register CNVT_B"]
pub type W = crate::W<u32, super::CNVT_B>;
#[doc = "Register CNVT_B `reset()`'s with value 0"]
impl crate::ResetValue for super::CNVT_B {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:3 - SPT_CNVT Signal Width: Half SPORT B"]
    #[inline(always)]
    ...
    #[doc = "Bits 16:23 - SPT_CNVT to FS Duration: Half SPORT B"]
    #[inline(always)]
