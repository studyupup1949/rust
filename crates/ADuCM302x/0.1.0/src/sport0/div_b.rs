#[doc = "Reader of register DIV_B"]
pub type R = crate::R<u32, super::DIV_B>;
#[doc = "Writer for register DIV_B"]
pub type W = crate::W<u32, super::DIV_B>;
#[doc = "Register DIV_B `reset()`'s with value 0"]
impl crate::ResetValue for super::DIV_B {
    type Type = u32;
    #[inline(always)]
