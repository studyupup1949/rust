#[doc = "Reader of register IEN_A"]
pub type R = crate::R<u32, super::IEN_A>;
#[doc = "Writer for register IEN_A"]
pub type W = crate::W<u32, super::IEN_A>;
#[doc = "Register IEN_A `reset()`'s with value 0"]
impl crate::ResetValue for super::IEN_A {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Transfer Finish Interrupt Enable\n\nValue on reset: 0"]
...
impl R {
    #[doc = "Bit 0 - Transfer Finish Interrupt Enable"]
    #[inline(always)]
    pub fn tf(&self) -> TF_R {
