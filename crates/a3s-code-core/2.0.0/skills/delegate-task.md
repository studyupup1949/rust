---
name: delegate-task
description: Delegate complex or multi-step tasks to specialized sub-agents using task and parallel_task. Use when work can be parallelized, requires focused exploration, or benefits from isolated execution.
allowed-tools: "task(*), parallel_task(*)"
kind: instruction
tags:
  - delegation
  - subagents
...
- **Keep delegation explicit**: Break unknown work into a planning `task`, then fan out known independent work with `parallel_task`
