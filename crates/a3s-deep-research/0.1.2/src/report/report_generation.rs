...
#[derive(Clone, Copy, Debug, Default, Deserialize, Eq, PartialEq, Serialize)]
#[serde(rename_all = "snake_case")]
pub enum ReportSectionComposition {
    #[default]
    Prose,
    KeyPoints,
    Comparison,
...
pub struct ReportSectionTreatment {
    pub heading: String,
    pub rhythm: ReportSectionRhythm,
    pub composition: ReportSectionComposition,
}

#[derive(Clone, Debug, Default, Deserialize, Eq, PartialEq, Serialize)]
#[serde(deny_unknown_fields)]
pub struct ReportPresentation {
    pub narrative_mode: ReportNarrativeMode,
    pub archetype: ReportArchetype,
    pub palette: ReportPalette,
    pub density: ReportDensity,
    pub hero: ReportHero,
    pub visual_stance: ReportVisualStance,
    pub rationale: String,
    pub section_plan: Vec<ReportSectionTreatment>,
}
...
#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
#[serde(deny_unknown_fields)]
pub struct ReportTrackCoverage {
    pub obligation_id: String,
    pub status: ReportTrackStatus,
    pub finding: String,
...
#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
#[serde(deny_unknown_fields)]
pub struct ReportEditorialPlan {
    pub thesis: String,
    pub track_coverage: Vec<ReportTrackCoverage>,
}

#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
#[serde(deny_unknown_fields)]
pub struct GeneratedDeepResearchReport {
    pub markdown: String,
    pub editorial: ReportEditorialPlan,
    pub presentation: ReportPresentation,
}

pub fn validate_report_obligation_coverage(
...
pub fn deep_research_report_frame_schema() -> serde_json::Value {
    serde_json::json!({
        "type": "object",
...
pub fn deep_research_report_from_generation(
    output: &str,
    exit_code: i32,
...
mod tests {
    ...
    fn report_generation_rejects_unapproved_presentation_values() {
        ...
        object["presentation"]["archetype"] = serde_json::json!("topic-specific-special");
