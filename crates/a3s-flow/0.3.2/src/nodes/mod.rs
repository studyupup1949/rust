...
//!
//! **Note**: Service-specific integrations (MCP, custom APIs, etc.) should be
//! implemented as custom nodes and registered dynamically. See the repository's
//! `examples/` directory for custom node implementations.
//!
...
pub mod code;
pub mod cond;
/// Read values from the shared execution context.
pub mod context_get;
/// Write values into the shared execution context.
pub mod context_set;
pub mod end;
pub mod http;
pub mod iteration;
