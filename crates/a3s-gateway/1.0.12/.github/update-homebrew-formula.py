...
formula = (
    ...
    '  on_macos do\n'
    '    on_arm do\n'
    f'      url "{base}/a3s-gateway-{ver}-darwin-arm64.tar.gz"\n'
    f'      sha256 "{sha_macos_arm64}"\n'
    '    end\n'
    '    on_intel do\n'
    f'      url "{base}/a3s-gateway-{ver}-darwin-x86_64.tar.gz"\n'
    ...
    '  on_linux do\n'
    '    on_arm do\n'
    f'      url "{base}/a3s-gateway-{ver}-linux-arm64-musl.tar.gz"\n'
    f'      sha256 "{sha_linux_arm64}"\n'
    '    end\n'
    '    on_intel do\n'
    f'      url "{base}/a3s-gateway-{ver}-linux-x86_64-musl.tar.gz"\n'
