...
test:
    ...
    print_header "🧪 A3S Lane Test Suite"
    echo ""
    echo -ne "${CYAN}▶${RESET} ${BOLD}a3s-lane${RESET} "
...
# Test manager module
test-manager:
    cargo test --lib -- manager::tests

# Test monitor module
test-monitor:
    cargo test --lib -- monitor::tests
...
test-cov:
    ...
    print_header "🧪 A3S Lane Test Suite with Coverage"
    echo ""
    echo -e "${CYAN}▶${RESET} ${BOLD}a3s-lane${RESET}"
    echo ""

    # Temp files for tracking
    tmp_dir="/tmp/test_cov_lane_$$"
    mkdir -p "$tmp_dir"
...
cov:
    #!/usr/bin/env bash
    set -e
    COV_FILE="/tmp/a3s-lane-coverage.lcov"
    echo "┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓"
...
publish:
    ...
    echo ""
    echo -e "${BOLD}${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${RESET}"
    echo -e "${BOLD}  📦 Publishing a3s-lane to crates.io${RESET}"
    echo -e "${BOLD}${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${RESET}"
    echo ""
    ...
    if cargo publish; then
        echo ""
        echo -e "${BOLD}${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${RESET}"
        echo -e "  ${GREEN}${BOLD}✓ Successfully published a3s-lane v${VERSION}${RESET}"
        echo -e "${BOLD}${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${RESET}"
    else
