---
name: a8e-doc-guide
description: Reference a8e documentation to create, configure, or explain a8e-specific features like recipes, extensions, sessions, and providers. You MUST fetch relevant a8e docs before answering. You MUST NOT rely on training data or assumptions for any a8e-specific fields, values, names, syntax, or commands.
---

Use this skill when working with **a8e-specific features**:
- Creating or editing recipes
- Configuring extensions or providers
- Explaining how a8e features work
- Any a8e configuration or setup task

Do NOT use this skill for:
- General coding tasks unrelated to a8e
- Running existing recipes (just run them directly)

## Steps (COMPLETE ALL BEFORE RESPONDING)
1. **Fetch official docs**
   - Fetch the doc map from the a8e documentation site
   - Search the doc map for pages relevant to the user's topic and get the paths for these pages
   - Use the EXACT paths from the doc map.
...
2. **Create/modify content**
   - For a8e configuration files:
      ...
      - **Verify output content MUST match the schema and reference in the official documentation:**
...
3. **MANDATORY VERIFICATION - CHECK ALL THESE ITEMS BEFORE STEP 4**
   ...
   - [ ] You MUST NOT rely on training data or assumptions for any a8e-specific fields, values, names, syntax, or commands.
   ...
   - [ ] List all a8e-specific items in your answer (commands, fields, syntax, values, how to use, explanations, etc.)
...
4. **Provide your answer and include a "Verification Completed" section**
   - For EACH a8e-specific item in your response, cite the specific doc file where you verified it
