...
const A8E_RECIPE_RETRY_TIMEOUT_SECONDS: &str = "A8E_RECIPE_RETRY_TIMEOUT_SECONDS";

/// Environment variable for configuring on_failure timeout globally
const A8E_RECIPE_ON_FAILURE_TIMEOUT_SECONDS: &str = "A8E_RECIPE_ON_FAILURE_TIMEOUT_SECONDS";
...
fn get_retry_timeout(retry_config: &RetryConfig) -> Duration {
    let timeout_seconds = retry_config
        ...
        .or_else(|| {
            ...
            config.get_param(A8E_RECIPE_RETRY_TIMEOUT_SECONDS).ok()
        })
