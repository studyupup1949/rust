...
<html>
  <head>
    <title>Articulate - ChatGPT Authorization Successful</title>
    <style>
      body {
  ...
  <body>
    <div class="container">
      ...
      <p>You can close this window and return to Articulate.</p>
    </div>
...
<html>
  <head>
    <title>Articulate - ChatGPT Authorization Failed</title>
    <style>
      body {{
        font-family: system-ui, -apple-system, sans-serif;
        display: flex;
