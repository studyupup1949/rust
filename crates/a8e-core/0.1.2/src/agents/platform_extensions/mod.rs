    ...
    || {
        ...
        map.insert(
            ...
            PlatformExtensionDef {
                ...
                display_name: "Todo",
                description:
                    "Enable a todo list for Articulate so it can keep track of what it is doing",
        ...
        map.insert(
            ...
            PlatformExtensionDef {
                ...
                display_name: "Apps",
                description:
                    "Create and manage custom Articulate apps through chat. Apps are HTML/CSS/JavaScript and run in sandboxed windows.",
                default_enabled: true,
                unprefixed_tools: false,
        ...
        map.insert(
            ...
            PlatformExtensionDef {
                ...
                description:
                    "Articulate will make extension calls through code execution, saving tokens",
                default_enabled: false,
                unprefixed_tools: true,
                client_factory: |ctx| {
        ...
        map.insert(
            ...
            PlatformExtensionDef {
                ...
                description:
                    "Inject custom context into every turn via A8E_MOIM_MESSAGE_TEXT and A8E_MOIM_MESSAGE_FILE environment variables",
                default_enabled: true,
                unprefixed_tools: false,
