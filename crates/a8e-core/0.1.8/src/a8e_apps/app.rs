...
impl GooseApp {
    ...
    const A8E_SCHEMA_CONTEXT: &'static str = "urn:a8e.ai:schema";
    ...
    pub fn from_html(html: &str) -> Result<Self, String> {
        ...
        let json_str = metadata_re
            ...
            .ok_or_else(|| "No ArticulateApp JSON-LD metadata found in HTML".to_string())?
            .as_str();
    ...
    pub fn to_html(&self) -> Result<String, String> {
        ...
        let mut metadata = serde_json::json!({
            "@context": Self::A8E_SCHEMA_CONTEXT,
            "@type": Self::A8E_APP_TYPE,
