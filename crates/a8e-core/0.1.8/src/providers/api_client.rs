...
impl TlsConfig {
    ...
    pub fn from_config() -> Result<Option<Self>> {
        ...
        let client_cert_path = config.get_param::<String>("A8E_CLIENT_CERT_PATH").ok();
        let client_key_path = config.get_param::<String>("A8E_CLIENT_KEY_PATH").ok();
        ...
        if let Ok(ca_cert_path) = config.get_param::<String>("A8E_CA_CERT_PATH") {
