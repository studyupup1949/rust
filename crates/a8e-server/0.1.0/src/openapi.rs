...
use a8e_core::dictation::download_manager::{DownloadProgress, DownloadStatus};
use a8e_core::model::ModelConfig;
use a8e_core::permission::permission_confirmation::{Permission, PrincipalType};
use a8e_core::providers::base::{ConfigKey, ModelInfo, ProviderMetadata, ProviderType};
use a8e_core::session::{Session, SessionInsights, SessionType, SystemInfo};
use rmcp::model::{
...
#[openapi(
    ...
    components(schemas(
        ...
        a8e_core::prompt_template::Template,
        ...
        Conversation,
        IconSchema,
        a8e_core::session::extension_data::ExtensionData,
        ...
        a8e_core::scheduler::ScheduledJob,
        ...
        a8e_core::recipe::Recipe,
        a8e_core::recipe::Author,
        a8e_core::recipe::Settings,
        a8e_core::recipe::RecipeParameter,
        a8e_core::recipe::RecipeParameterInputType,
        a8e_core::recipe::RecipeParameterRequirement,
        a8e_core::recipe::Response,
        a8e_core::recipe::SubRecipe,
        a8e_core::agents::types::RetryConfig,
        a8e_core::agents::types::SuccessCheck,
        ...
        a8e_core::agents::ExtensionLoadResult,
        ...
        a8e_core::a8e_apps::PermissionsMetadata,
        a8e_core::a8e_apps::UiMetadata,
        a8e_core::a8e_apps::ResourceMetadata,
        super::routes::dictation::TranscribeRequest,
        super::routes::dictation::TranscribeResponse,
        a8e_core::dictation::providers::DictationProvider,
