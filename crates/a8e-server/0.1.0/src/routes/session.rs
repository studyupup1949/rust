    ...
    let target_session_id = if request.copy {
        let original = session_manager
            ...
            .map_err(|e| {
                ...
                a8e_core::posthog::emit_error("session_get_failed", &e.to_string());
                ErrorResponse {
        ...
        let copied = session_manager
            ...
            .map_err(|e| {
                ...
                a8e_core::posthog::emit_error("session_copy_failed", &e.to_string());
                ErrorResponse {
    ...
    if request.truncate {
        session_manager
            ...
            .map_err(|e| {
                ...
                a8e_core::posthog::emit_error("session_truncate_failed", &e.to_string());
                ErrorResponse {
