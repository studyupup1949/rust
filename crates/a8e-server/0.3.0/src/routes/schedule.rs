...
use a8e_core::scheduler::{get_default_scheduled_recipes_dir, ScheduledJob};
...
async fn create_schedule(
    ...
    scheduler
        ...
        .await
        .map_err(|e| match e {
            a8e_core::scheduler::SchedulerError::CronParseError(msg) => {
                ErrorResponse::bad_request(format!("Invalid cron expression: {}", msg))
            }
            a8e_core::scheduler::SchedulerError::RecipeLoadError(msg) => {
                ErrorResponse::bad_request(format!("Recipe load error: {}", msg))
            }
            a8e_core::scheduler::SchedulerError::JobIdExists(msg) => ErrorResponse {
...
async fn delete_schedule(
    ...
    scheduler
        ...
        .await
        .map_err(|e| match e {
            a8e_core::scheduler::SchedulerError::JobNotFound(msg) => {
...
async fn run_now_handler(
    ...
    match scheduler.run_now(&id).await {
        ...
        Err(e) => match e {
            a8e_core::scheduler::SchedulerError::JobNotFound(msg) => Err(ErrorResponse::not_found(
                format!("Schedule not found: {}", msg),
            )),
            a8e_core::scheduler::SchedulerError::AnyhowError(ref err) => {
...
async fn pause_schedule(
    ...
    scheduler.pause_schedule(&id).await.map_err(|e| match e {
        ...
        a8e_core::scheduler::SchedulerError::AnyhowError(err) => {
