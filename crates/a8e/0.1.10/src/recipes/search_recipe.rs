...
use super::github_recipe::{
    ...
    A8E_RECIPE_GITHUB_REPO_CONFIG_KEY,
};
use a8e_core::recipe::local_recipes::{list_local_recipes, load_local_recipe_file};
...
fn configured_github_recipe_repo() -> Option<String> {
    ...
    match config.get_param(A8E_RECIPE_GITHUB_REPO_CONFIG_KEY) {
