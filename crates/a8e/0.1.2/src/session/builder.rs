...
/// Configuration for building a new Articulate session
///
...
async fn offer_extension_debugging_help(
    extension_name: &str,
    error_message: &str,
    provider: Arc<dyn a8e_core::providers::base::Provider>,
    interactive: bool,
) -> Result<(), anyhow::Error> {
...
async fn load_extensions(
    ...
    provider_for_debug: Arc<dyn a8e_core::providers::base::Provider>,
    interactive: bool,
    session_id: &str,
) -> Arc<Agent> {
...
struct ResolvedProviderConfig {
    ...
    model_name: String,
    model_config: a8e_core::model::ModelConfig,
}
...
fn resolve_provider_and_model(
    ...
    saved_model_config: Option<a8e_core::model::ModelConfig>,
...
async fn resolve_session_id(
    session_config: &SessionBuilderConfig,
    session_manager: &a8e_core::session::session_manager::SessionManager,
) -> String {
...
pub async fn build_session(session_config: SessionBuilderConfig) -> CliSession {
    a8e_core::posthog::set_session_context("cli", session_config.resume);
    ...
    .await
    {
        ...
        Err(e) => {
            output::render_error(&format!(
                "Error {}.\n\
                Please check your system keychain and run 'a8e configure' again.\n\
                If your system is unable to use the keyring, please try setting secret key(s) via environment variables.\n\
                For more info, see: https://block.github.io/a8e/docs/troubleshooting/#keychainkeyring-errors",
                e
            ));
            process::exit(1);
        }
    ...
    fn test_session_builder_config_creation() {
        let config = SessionBuilderConfig {
            ...
            streamable_http_extensions: vec![StreamableHttpOptions {
                ...
                timeout: a8e_core::config::DEFAULT_EXTENSION_TIMEOUT,
            }],
