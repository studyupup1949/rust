...
mod tests {
    use super::*;
    use a8e_core::conversation::message::{Message, ToolRequest, ToolResponse};
...
if __name__ == "__main__":
    ...
    fn test_shell_tool_with_build_output() {
        ...
        let build_output = r#"   Compiling a8e-cli v0.1.0 (/Users/user/a8e)
...
10 |     let x = 5;
   ...
   = note: `#[warn(unused_variables)]` on by default
    ...
    Finished dev [unoptimized + debuginfo] target(s) in 2.45s"#;
        ...
        assert!(response_result.contains("Compiling a8e-cli"));
