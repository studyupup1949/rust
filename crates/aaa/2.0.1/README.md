...
## Installation
### Arch
aaa is available in [aur](https://aur.archlinux.org/packages/aaa-bin)

## Installation
### Binary
If none of the options listed below work for you, you can always just download
a statically linked executable for your platform from the [releases page](https://github.com/asciimoth/aaa/releases/latest).
### Nix
