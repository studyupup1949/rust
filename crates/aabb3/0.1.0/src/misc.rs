...
use super::{AABB3, copy, new_identity};
...
/// ~~~
#[inline]
pub fn expand_point<'out, 'a, 'b, T>(out: &'out mut AABB3<T>, aabb3: &'a AABB3<T>, p: &'b [T; 3]) -> &'out mut AABB3<T>
    where T: Copy + Num,
{
...
/// ~~~
#[inline]
pub fn expand_vector<'out, 'a, 'b, T>(out: &'out mut AABB3<T>, aabb3: &'a AABB3<T>, v: &'b [T; 3]) -> &'out mut AABB3<T>
    where T: Copy + Num,
{
...
/// ~~~
#[inline]
pub fn expand_scalar<'out, 'a, T>(out: &'out mut AABB3<T>, aabb3: &'a AABB3<T>, s: T) -> &'out mut AABB3<T>
    where T: Copy + Num,
{
...
/// ~~~
#[inline]
pub fn union<'out, 'a, 'b, T>(out: &'out mut AABB3<T>, a: &'a AABB3<T>, b: &'b AABB3<T>) -> &'out mut AABB3<T>
    where T: Copy + Num,
{
...
/// ~~~
#[inline]
pub fn from_center_size<'out, 'a, 'b, T>(out: &'out mut AABB3<T>, center: &'a [T; 3], size: &'b [T; 3]) -> &'out mut AABB3<T>
    where T: Copy + Num,
{
...
/// ~~~
#[inline]
pub fn from_center_radius<'out, 'a, T>(out: &'out mut AABB3<T>, center: &'a [T; 3], radius: T) -> &'out mut AABB3<T>
    where T: Copy + Num,
{
