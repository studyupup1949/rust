...
async fn test_load_and_call_openclaw_audit_skill() -> anyhow::Result<()> {
    // 1. Setup paths
    // The skill is already installed at /home/biubiuboy/aagt/skills/openclaw-memory-audit
    let base_path = Path::new("/home/biubiuboy/aagt/skills");
    ...
    let skill_name = "openclaw-memory-audit";
    ...
    // we use the AAGT_UNSAFE_SKILL_EXEC override for the test environment.
