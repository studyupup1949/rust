...
## [0.8.0](https://git.sr.ht/~onemoresuza/aba/refs/0.8.0) - 2023-11-27

### Build

- Remove override from `crane` input ([76a946a](https://git.sr.ht/~onemoresuza/aba/commit/76a946a804095cb45b4c55518fb80b731cf6a13e))
- Rework the default option of install recipes ([c8e6c1c](https://git.sr.ht/~onemoresuza/aba/commit/c8e6c1cc17f454a455d87134fce7975feaa964e2))
- Unclutter flake apps ([9a6c101](https://git.sr.ht/~onemoresuza/aba/commit/9a6c10198528701c6c023c72a28217ca5504206b))
- Remove `rust-overlay` in favor of `fenix` ([8a4a950](https://git.sr.ht/~onemoresuza/aba/commit/8a4a950cf6913aaa51197064dd0ea931f0635521))
- Add nix-fast-build to ci ([e6fe240](https://git.sr.ht/~onemoresuza/aba/commit/e6fe2404ccc3ed5a8f8f509f604cdd2c566a7116))
- Refactor abaMusl ([3475177](https://git.sr.ht/~onemoresuza/aba/commit/3475177ff97b791323126da0f4e2f0dabdf506e2))
- Fix typo in `nix-fast-build` invocation ([3d9efb9](https://git.sr.ht/~onemoresuza/aba/commit/3d9efb90164ef3f5424600c4ef2b2b4f923f2c95))
- Fix typo on env var name ([fb01f0f](https://git.sr.ht/~onemoresuza/aba/commit/fb01f0fbd8bed34075b219ff253489064b8865f6))

### Documentation

- Add more comments to .ci devShell ([c40b86b](https://git.sr.ht/~onemoresuza/aba/commit/c40b86bac2bf5bd9bec68c5080aca4cd366625ce))

### Miscellaneous Tasks

- Change mailing lists on README ([46675f1](https://git.sr.ht/~onemoresuza/aba/commit/46675f13d10aa6a823ecc921a7099028dc16ba31))
- Update dependencies ([be8de93](https://git.sr.ht/~onemoresuza/aba/commit/be8de930f0915c1b3cea2b4a13297ea34a668e57))

### Refactor

- Remove miette ([3969f51](https://git.sr.ht/~onemoresuza/aba/commit/3969f5181a67bc81708e1282e364bdb36ed239af))

### Flake.lock

- Update ([d5e3a52](https://git.sr.ht/~onemoresuza/aba/commit/d5e3a52aea0889f90b002b8710aef8b2e34bb130))
