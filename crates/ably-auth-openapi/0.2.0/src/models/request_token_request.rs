...
#[serde(untagged)]
pub enum RequestTokenRequest {
    TokenRequest(Box<models::TokenRequest>),
    TokenParams(Box<models::TokenParams>),
}

impl Default for RequestTokenRequest {
    fn default() -> Self {
        Self::TokenRequest(Default::default())
    }
}
