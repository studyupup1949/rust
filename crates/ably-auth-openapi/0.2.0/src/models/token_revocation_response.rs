...
/// TokenRevocationResponse : Per-target results of a revocation request.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct TokenRevocationResponse {
    #[serde(rename = "results", skip_serializing_if = "Option::is_none")]
    pub results: Option<Vec<models::TokenRevocationResponseResultsInner>>,
}

impl TokenRevocationResponse {
    /// Per-target results of a revocation request.
    pub fn new() -> TokenRevocationResponse {
