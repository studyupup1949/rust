...
/// MessageAction : The action that produced this message version.
...
impl std::fmt::Display for MessageAction {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            Self::MessageCreate => write!(f, "message.create"),
            Self::MessageUpdate => write!(f, "message.update"),
            Self::MessageDelete => write!(f, "message.delete"),
        }
    }
}

impl Default for MessageAction {
    fn default() -> MessageAction {
        Self::MessageCreate
    }
}
