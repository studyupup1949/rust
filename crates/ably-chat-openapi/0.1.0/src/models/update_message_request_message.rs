...
/// UpdateMessageRequestMessage : The new message content. All fields are replaced; omitted fields are reset to empty. 
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UpdateMessageRequestMessage {
    #[serde(rename = "text")]
    pub text: String,
...
impl UpdateMessageRequestMessage {
    /// The new message content. All fields are replaced; omitted fields are reset to empty. 
    pub fn new(text: String) -> UpdateMessageRequestMessage {
