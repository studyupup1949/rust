...
//!   bridging helpers.
//! - `thread`: most notibly [abpl::thread::ThreadPanicError] and [abpl::thread::cancelable::cancelable_sleep]
//! - `subcommand`: convenient ways to handle subprocesses, intended for more script-like programs.
//!   - [abpl::subcommand::cmd]
//!   - [abpl::subcommand::cmd_stdin]
//!   - [abpl::subcommand::cmd_stdout]
//!   - [abpl::subcommand::cmd_transform]
