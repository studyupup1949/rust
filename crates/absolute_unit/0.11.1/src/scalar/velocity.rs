use crate::{
    Acceleration, AngleUnit, AngularVelocity, DynamicUnits, Length, LengthUnit, Radians, Real,
    Time, TimeUnit, VelocitySquared, impl_value_type_conversions, supports_absdiffeq,
