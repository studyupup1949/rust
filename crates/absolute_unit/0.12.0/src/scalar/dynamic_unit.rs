...
impl DynamicUnits {
    ...
    pub fn new1o1<N0, D0>(v: Real) -> Self
    where
        N0: Unit + 'static,
        D0: Unit + 'static,
    {
    ...
    pub fn new1o2<N0, D0, D1>(v: Real) -> Self
    where
        N0: Unit + 'static,
        D0: Unit + 'static,
        D1: Unit + 'static,
    ...
    pub fn new1o3<N0, D0, D1, D2>(v: Real) -> Self
    where
        N0: Unit + 'static,
        D0: Unit + 'static,
        D1: Unit + 'static,
    ...
    pub fn new2o0<N0, N1>(v: Real) -> Self
    where
        N0: Unit + 'static,
        N1: Unit + 'static,
    {
    ...
    pub fn new2o2<N0, N1, D0, D1>(v: Real) -> Self
    where
        N0: Unit + 'static,
        N1: Unit + 'static,
        D0: Unit + 'static,
    ...
    pub fn new3o0<N0, N1, N2>(v: Real) -> Self
    where
        N0: Unit + 'static,
        N1: Unit + 'static,
        N2: Unit + 'static,
    ...
    pub fn new3o2<N0, N1, N2, D0, D1>(v: Real) -> Self
    where
        N0: Unit + 'static,
        N1: Unit + 'static,
        N2: Unit + 'static,
