...
| 0291 | TextArea placeholder never paints on an autofocused composer — opt-in placeholder-while-focused (renumbered from 0310: band collision with control-plane, wave-3 CLOSER) | API gap |
...
| 0299 | Public full-redraw verb (poison-prev semantics) + optional focus-regain repaint — external clears leave the terminal desynced forever (renumbered from 0300: band collision with control-plane, wave-3 CLOSER) | API gap |
