...
#[must_use = "ResultAcceptor must be used to forward results to the correct acceptor"]
#[derive(Debug, Clone)]
pub struct ResultAcceptor<OkValue, ErrValue, OkAccepts, ErrAccepts>
where
...
impl<OkValue, ErrValue, OkAccepts, ErrAccepts>
    ResultAcceptor<OkValue, ErrValue, OkAccepts, ErrAccepts>
where
    OkAccepts: Accepts<OkValue>,
    ErrAccepts: Accepts<ErrValue>,
{
    /// Creates a new `ResultAcceptor`.
...
impl<OkValue, ErrValue, OkAccepts, ErrAccepts> Accepts<Result<OkValue, ErrValue>>
    for ResultAcceptor<OkValue, ErrValue, OkAccepts, ErrAccepts>
where
    OkAccepts: Accepts<OkValue>,
    ErrAccepts: Accepts<ErrValue>,
{
