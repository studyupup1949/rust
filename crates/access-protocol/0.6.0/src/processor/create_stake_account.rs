...
use solana_program::{account_info::{next_account_info, AccountInfo}, entrypoint::ProgramResult, msg, program_error::ProgramError, pubkey::Pubkey, system_program};
...
pub fn process_create_stake_account(
    ...
    msg!("Derived stake key: {:?} {:?} {:?} ", derived_stake_key,
    StakeAccount::find_key(
        &params.owner,
        accounts.stake_pool.key,
        program_id,
    ).0,
