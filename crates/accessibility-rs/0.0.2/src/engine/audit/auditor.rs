...
pub struct Auditor<'a> {
    ...
    pub match_context: selectors::matching::MatchingContext<'a, accessibility_scraper::selector::Simple>,
    /// layout handling
    pub taffy: Taffy,
}
...
impl<'a> Auditor<'a> {
    pub fn new(
        document: &'a Html,
        css_rules: &str,
        match_context: selectors::matching::MatchingContext<'a, accessibility_scraper::selector::Simple>,
    ) -> Auditor<'a> {
