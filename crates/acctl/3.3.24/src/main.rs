...
/// HMI App.tsx wrapping the four TIS components in a `<TisProvider>`
/// + three tabs. No prop-threading needed — the components read their
/// state from context.
const TIS_WWW_APP_TSX: &str = r#"import { useContext } from 'react';
import { EventEmitterProvider, EventEmitterContext } from '@adcops/autocore-react/core/EventEmitterContext';
...
async fn cmd_new_tis_project(name: String) -> Result<()> {
    ...
    println!("real schema; the Setup, Data, and History tabs all pick it up");
