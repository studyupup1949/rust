...
pub struct Arguments {
    ...
    pub threads: usize,
    /// Clear cache data from database (link_cache, validation_history, research_activity_cache tables)
...
pub enum Commands {
    ...
    /// Download research activity data from buckets or links
    ///
    ...
    ///     .acorn.json, .acorn.yaml, .acorn.yml
    ///     $> acorn download
    ///
    #[clap(verbatim_doc_comment, next_help_heading = "FLAGS")]
    ...
    /// Gather (extract) research activity data
    ///
    ///     $> acorn gather /path/to/data/
    ///
    #[clap(verbatim_doc_comment, next_help_heading = "FLAGS")]
...
pub enum DownloadCommands {
    /// Download model metadata from models.dev into the local database
    Model(Box<arguments::DownloadModel>),
}
#[derive(Debug, Subcommand)]
#[command(long_about = None)]
pub enum ImportCommands {
    /// Import model metadata from models.dev into the local database
    Model,
