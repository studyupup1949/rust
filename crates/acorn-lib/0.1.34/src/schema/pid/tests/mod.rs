...
use crate::schema::pid::{
    iso7064_check_digit, noid_check_digit, raid, Betanumeric, PersistentIdentifier, PersistentIdentifierConvert, ARK, DOI, ORCID, PID,
};
...
fn test_ark() {
    ...
    let ark = ARK::from_string(valid);
    assert_eq!(ark.prefix(), Some("ark:12148/btv1b8449691v".to_string()));
    assert_eq!(ark.suffix(), Some("f29".to_string()));
    assert_eq!(ark.identifier(), "ark:12148/btv1b8449691v/f29");
}
#[test]
fn test_ark_struct() {
    let valid = "https://n2t.net/ark:12148/btv1b8449691v/f29";
