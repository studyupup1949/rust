...
/// Prints a diff of changes between two strings, optionally using ANSI colors.
...
/// Returns line-oriented diff changes, optionally formatted with ANSI colors.
