...
use crate::object::*;
// ACROFORM-RS: Removed crypt::Decoder import - only supporting decrypted PDFs
...
pub fn parse_indirect_object(lexer: &mut Lexer, r: &impl Resolve, flags: ParseFlags) -> Result<(PlainRef, Primitive)> {
    let id = PlainRef {
