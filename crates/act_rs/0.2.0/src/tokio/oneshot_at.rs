...
///
/// The sender part of a wrapped Oneshot that allows you to check if a value has been sent or recived.
/// 
pub struct Sender<T>
{
...
///
/// The receiver part of a wrapped Oneshot that allows you to check if a value has been sent or recived.
/// 
