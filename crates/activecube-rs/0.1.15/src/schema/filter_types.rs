...
pub fn build_filter_primitives() -> Vec<InputObject> {
    vec![
        ...
        InputObject::new("FloatFilter")
            ...
            .field(InputValue::new("eq", TypeRef::named(TypeRef::FLOAT)).description("Equal to"))
            .field(InputValue::new("ne", TypeRef::named(TypeRef::FLOAT)).description("Not equal to"))
            .field(InputValue::new("gt", TypeRef::named(TypeRef::FLOAT)).description("Greater than"))
            .field(InputValue::new("ge", TypeRef::named(TypeRef::FLOAT)).description("Greater than or equal to"))
            .field(InputValue::new("lt", TypeRef::named(TypeRef::FLOAT)).description("Less than"))
            .field(InputValue::new("le", TypeRef::named(TypeRef::FLOAT)).description("Less than or equal to"))
            .field(InputValue::new("in", TypeRef::named_nn_list(TypeRef::FLOAT)).description("Matches any value in the list"))
            .field(InputValue::new("notIn", TypeRef::named_nn_list(TypeRef::FLOAT)).description("Does not match any value in the list"))
            .field(InputValue::new("isNull", TypeRef::named(TypeRef::BOOLEAN)).description("True to match NULL, false to match non-NULL")),
