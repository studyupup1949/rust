...
/// Extract column names that are produced by aggregate Merge functions in a subquery.
/// These are the AS aliases of expressions like `sumMerge(col) AS col`.
fn extract_subquery_agg_aliases(subquery: &str) -> HashSet<String> {
