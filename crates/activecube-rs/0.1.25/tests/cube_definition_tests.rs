...
fn test_cube_definition_table_resolution() {
    let cube = CubeDefinition {
        ...
        lowercase_filter_columns: vec![], aggregate_only_fields: vec![],
    };
...
fn test_registry_lookup() {
    let cubes = vec![
        CubeDefinition {
            ...
            chain_groups: vec![], chain_overrides: HashMap::new(), lowercase_filter_columns: vec![], aggregate_only_fields: vec![],
        },
        CubeDefinition {
