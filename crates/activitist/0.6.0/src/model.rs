...
pub struct Link {
    ...
    pub object_items: Box<ObjectItems>,
}
...
impl ObjectItems {
    ...
    pub fn is_empty(&self) -> bool {
        self.attachment.is_empty()
            ...
            && self.summary_map.is_empty()
            && self.updated.is_none()
            && self.describes.is_none()
    }
}
...
impl From<String> for Link {
    fn from(value: String) -> Self {
        Self {
            ...
            rel: vec![],
            width: None,
            object_items: Box::new(ObjectItems::empty()),
        }
    }
}
