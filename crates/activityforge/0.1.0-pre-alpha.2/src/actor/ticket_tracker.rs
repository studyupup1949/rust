...
create_actor! {
    ...
    ///
    /// ```rust
    /// use activityforge::{TicketTracker, context};
    ...
    ///
    /// let repository = TicketTracker::new()
    ...
    /// assert_eq!(
    ///     serde_json::from_str::<TicketTracker>(json_str.as_str()).unwrap(),
    ///     repository
    /// );
    /// # }
    /// ```
    ...
    ///
    /// ```rust
    /// use activityforge::{ActorType, TicketTracker, VocabularyTypes, context};
    /// use activitystreams_vocabulary::{
    ///     Iri, MultibaseHeader, MultibasePublicKey, Multikey, MultikeyPublicKey, Name,
    /// };
    ///
    ...
    /// # }
    /// ```
    TicketTracker: crate::ActorType::TicketTracker {}
}

create_item! {
    TicketTrackerItem
        boxed
        default: Self::TicketTracker(Box::default()),
    {
