use activitystreams_vocabulary::{
    CollectionItem, Iri, Iris, LinkItem, ObjectItems, OrderedCollectionItem, create_actor,
    create_item, field_access,
};

use crate::PatchTrackerItem;
...
create_actor! {
    ...
    Repository: crate::ActorType::Repository {
        ...
        #[serde(skip_serializing_if = "Option::is_none")]
        tickets_tracked_by: Option<ObjectItems>,
        #[serde(skip_serializing_if = "Option::is_none")]
...
field_access! {
    Repository {
        ...
        team: option_ref { CollectionItem },
    }
}
