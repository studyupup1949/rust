...
use crate::{CoreType, Error, Iri, Result, create_object, impl_into_item, impl_into_items};
...
impl From<&[Object]> for Objects {
    fn from(val: &[Object]) -> Self {
        Self::List(Box::new(val.into_iter().cloned().collect()))
    }
}
...
mod tests {
    use super::*;
    use crate::{Iri, LanguageMap, LanguageTag, Link, Name, NameMap};
