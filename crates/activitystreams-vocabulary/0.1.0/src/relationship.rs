use crate::{
    Item, ObjectType, Objects, create_object, derived_kind_serde, field_access, impl_into_object,
};
...
derived_kind_serde!(crate::ObjectType::Relationship);
impl_into_object!(Relationship);
