...
use activitystreams_vocabulary::{
    ActivityVocabulary, create_actor, create_object, derived_kind_serde, field_access, impl_into_object,
};
...
create_object! {
    ...
    ExternalObject:
        ...
        external_vocab::ExternalType::TestObject {
...
// Creates a custom serializer function for the vocabulary type field.
derived_kind_serde!(external_vocab::ExternalType::TestObject);
// Implement conversion into a base `Object` type.
impl_into_object!(ExternalObject);
```
