...
use crate::{
    Error, Iri, Link, OrderedItems, Result, create_object, derived_kind_serde, field_access,
...
derived_kind_serde!(crate::CoreType::OrderedCollection);
impl_into_object!(OrderedCollection);
