        ...
        $crate::paste! {
            $crate::create_object! {
                ...
                $ty:
                    ...
                    #[serde(skip_serializing_if = "Option::is_none")]
                    assertion_method: Option<$crate::Multikeys>,
                    $(
                        $(#[$field_serde])*
                        $field: $field_ty,
                    )*
            ...
            $crate::derived_kind_serde!($actor_path::$actor_ty::$actor_var);
            ...
            $crate::field_access! {
                $ty {
                    ...
                    assertion_method: option_ref { $crate::Multikeys },
                }
            }
        }
    };
