...
use crate::{
    Error, Iri, Result, create_item, create_list, create_object, impl_default, impl_display,
    impl_into_item, impl_into_items,
};
...
create_object! {
    ...
    /// # }
    /// ```
    Object: base crate::CoreType::Object {}
}
...
create_item! {
    /// Represents an field that can be an [Iri] or [Object], but not a [Link](crate::Link).
    ObjectItem
        boxed
        default: Self::Object(Box::default()),
    {
        Object(Object),
        Iri(Iri),
    }
...
#[deprecated(
    since = "0.4.2",
    note = "Did not handle the edge-case where a mixed list of IRI and Objects are used. Use [ObjectItems] instead."
)]
pub enum Objects {
    Single(Box<Object>),
    List(Box<Vec<Object>>),
