...
create_item! {
    ...
    CollectionPageItem
        boxed
        default: Self::CollectionPage(Box::default()),
    {
...
create_list! {
    /// Represents a list of [CollectionPageItem]s.
    CollectionPageItems: CollectionPageItem,
}
...
mod tests {
  ...
  "partOf": "{part_of}"
        ...
        let collection_page: Object = CollectionPage::new()
            .with_summary(summary)
            .with_id(id)
            .with_part_of(part_of)
            .with_items(items)
