...
use crate::{
    DateTime, Error, ObjectItems, Result, create_object, field_access, impl_default, impl_display,
};
...
create_object! {
    ...
    Tombstone: ObjectType {
        ...
        #[serde(skip_serializing_if = "Option::is_none")]
        former_type: Option<ObjectItems>,
    }
}
...
field_access! {
    Tombstone<Vocab> {
        ...
        former_type: option_ref { ObjectItems },
    }
}
