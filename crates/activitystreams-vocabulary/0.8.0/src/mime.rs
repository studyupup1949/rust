...
pub enum MimeType {
    ...
    #[serde(rename = "application/x-git-upload-pack-request")]
    ApplicationGitUploadPackRequest,
    #[serde(rename = "application/x-git-upload-pack-result")]
    ApplicationGitUploadPackResult,
    #[serde(rename = "application/x-git-upload-pack-advertisement")]
    ApplicationGitUploadPackAdvertisement,
    #[serde(rename = "application/x-git-receive-pack-request")]
    ApplicationGitReceivePackRequest,
    #[serde(rename = "application/x-git-receive-pack-result")]
    ApplicationGitReceivePackResult,
    #[serde(rename = "application/x-git-receive-pack-advertisement")]
    ApplicationGitReceivePackAdvertisement,
    #[serde(rename = "audio")]
    Audio,
...
impl MimeType {
    ...
    pub const APPLICATION_GIT_UPLOAD_PACK_REQUEST: &str = "application/x-git-upload-pack-request";
    pub const APPLICATION_GIT_UPLOAD_PACK_RESULT: &str = "application/x-git-upload-pack-result";
    pub const APPLICATION_GIT_UPLOAD_PACK_ADVERTISEMENT: &str =
        "application/x-git-upload-pack-advertisement";
    pub const APPLICATION_GIT_RECEIVE_PACK_REQUEST: &str = "application/x-git-receive-pack-request";
    pub const APPLICATION_GIT_RECEIVE_PACK_RESULT: &str = "application/x-git-receive-pack-result";
    pub const APPLICATION_GIT_RECEIVE_PACK_ADVERTISEMENT: &str =
    ...
    pub const fn as_str(&self) -> &'static str {
        match self {
            ...
            Self::ApplicationGitUploadPackRequest => Self::APPLICATION_GIT_UPLOAD_PACK_REQUEST,
            Self::ApplicationGitUploadPackResult => Self::APPLICATION_GIT_UPLOAD_PACK_RESULT,
            Self::ApplicationGitUploadPackAdvertisement => {
                Self::APPLICATION_GIT_UPLOAD_PACK_ADVERTISEMENT
            }
            Self::ApplicationGitReceivePackRequest => Self::APPLICATION_GIT_RECEIVE_PACK_REQUEST,
            Self::ApplicationGitReceivePackResult => Self::APPLICATION_GIT_RECEIVE_PACK_RESULT,
            Self::ApplicationGitReceivePackAdvertisement => {
                Self::APPLICATION_GIT_RECEIVE_PACK_ADVERTISEMENT
            }
            ...
            Self::TextPlainUtf8 => Self::TEXT_PLAIN_UTF8,
    ...
    pub fn try_from_str(val: &str) -> Result<Self> {
        match val.to_lowercase().as_str() {
            ...
            Self::APPLICATION_GIT_UPLOAD_PACK_REQUEST => Ok(Self::ApplicationGitUploadPackRequest),
            Self::APPLICATION_GIT_UPLOAD_PACK_RESULT => Ok(Self::ApplicationGitUploadPackResult),
            Self::APPLICATION_GIT_UPLOAD_PACK_ADVERTISEMENT => {
                Ok(Self::ApplicationGitUploadPackAdvertisement)
            }
            Self::APPLICATION_GIT_RECEIVE_PACK_REQUEST => {
                Ok(Self::ApplicationGitReceivePackRequest)
            }
            Self::APPLICATION_GIT_RECEIVE_PACK_RESULT => Ok(Self::ApplicationGitReceivePackResult),
            Self::APPLICATION_GIT_RECEIVE_PACK_ADVERTISEMENT => {
                Ok(Self::ApplicationGitReceivePackAdvertisement)
            }
            ...
            Self::TEXT_PLAIN_UTF8 => Ok(Self::TextPlainUtf8),
