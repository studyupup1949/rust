...
#[cfg(feature = "paperclip")]
impl<T: paperclip::v2::schema::Apiv2Schema + paperclip::actix::OperationModifier> PaperclipSupport for T {}
#[cfg(not(feature = "paperclip"))]
...
impl<T: 'static + Default + Clone + PaperclipSupport> Deref for Payload<T> {
    type Target = T;
...
impl<T: 'static + Default + Clone + PaperclipSupport> DerefMut for Payload<T> {
