...
static_api_error!(conflict_error, StatusCode::CONFLICT);

static_api_error!(unauthorized_error, StatusCode::UNAUTHORIZED);

static_api_error!(bad_request_error, StatusCode::BAD_REQUEST);

static_api_error!(not_found_error, StatusCode::NOT_FOUND);

static_api_error!(internal_server_error, StatusCode::INTERNAL_SERVER_ERROR);
