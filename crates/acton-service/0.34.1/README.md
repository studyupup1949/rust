...
```toml
[dependencies]
acton-service = { version = "0.34", features = ["grpc", "database", "cache"] }
```
...
```toml
[dependencies]
acton-service = { version = "0.34", features = ["full"] }
```
...
```toml
[dependencies]
acton-service = { version = "0.34", default-features = false, features = [
    "http",
    "observability",
    "crypto-ring",
] }
