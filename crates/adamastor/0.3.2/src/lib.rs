//! # Adamastor
//!
//! Rust framework for building LLM Agents with type-safe structured outputs.
//!
//! ## Quick Start
//!
//! ```ignore
...
//!     let poem: Poem = agent.prompt("Write a haiku about Rust").await?;
...
/// Attribute macro for defining schema types.
///
/// Adds `Debug`, `Serialize`, `Deserialize`, and `JsonSchema` derives.
///
/// # Example
///
/// ```ignore
...
// Re-export serde and schemars traits/derives for users who need them directly
...
/// The embedding model to use for encoding operations
...
impl<'a> EncodeBuilder<'a> {
    ...
    /// Set the output vector dimensions (default: 3072)
