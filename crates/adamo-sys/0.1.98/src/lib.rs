...
/// Audio send options — mirrors the C ABI `adamo_audio_options_t`. Note the
/// flag fields are `bool` (C `_Bool`) and `channels` is `u8`, matching the
/// header cbindgen generates — unlike `adamo_video_options_t`, whose flags are
/// `i32`.
#[repr(C)]
#[derive(Clone, Copy)]
pub struct adamo_audio_options_t {
    pub source_type: *const c_char,
    pub device: *const c_char,
    pub pipeline: *const c_char,
    pub codec: *const c_char,
    pub bitrate_kbps: u32,
    pub sample_rate: u32,
    pub channels: u8,
...
unsafe extern "C" {
    ...
    /// 6 = internal, 7 = audio. Stable across releases.
    ...
    // -- Audio send (source-driven). Requires libadamo built with `audio`. --
    pub fn adamo_audio_options_default() -> adamo_audio_options_t;
    pub fn adamo_robot_attach_audio_alsa(
        robot: *mut adamo_robot_t,
        name: *const c_char,
        device: *const c_char,
        bitrate_kbps: u32,
    ...
    pub fn adamo_robot_attach_audio_test(
        robot: *mut adamo_robot_t,
        name: *const c_char,
    ) -> i32;
    pub fn adamo_robot_attach_audio_gst(
        robot: *mut adamo_robot_t,
        name: *const c_char,
        pipeline: *const c_char,
    ) -> i32;
    pub fn adamo_robot_attach_audio_configured(
        robot: *mut adamo_robot_t,
        name: *const c_char,
        opts: *const adamo_audio_options_t,
    ) -> i32;
    ...
    pub fn adamo_robot_stop(robot: *mut adamo_robot_t) -> i32;
