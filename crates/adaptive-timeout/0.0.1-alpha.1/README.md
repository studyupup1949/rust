...
let mut tracker = LatencyTracker::<u32, u64>::with_defaults(now);
...
let mut tracker = adaptive_timeout::LatencyTracker::<u32, u64, FakeInstant>::with_defaults(FakeInstant(0));
