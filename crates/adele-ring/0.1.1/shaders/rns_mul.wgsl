...
//
// WGSL has no u64. Every basis prime lives in (2^15, 2^16), so the product of
// two residues is < 2^32 and fits in u32 — the naive (a*b)%m is exact. This is
// precisely why the basis is restricted to that range (see basis.rs).
