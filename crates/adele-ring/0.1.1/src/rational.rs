...
impl RnsRational {
    ...
    ///
    /// Panics if `q == 0`.
    pub fn new(p: BigInt, q: BigInt, channels: Basis) -> Self {
    ...
    pub fn from_fraction(p: i64, q: i64, channels: Basis) -> Self {
        Self::new(BigInt::from(p), BigInt::from(q), channels)
    }

    /// An integer rational `n/1`.
    pub fn from_int(n: i64, channels: Basis) -> Self {
    ...
    pub fn from_f64(x: f64, channels: Basis) -> Self {
