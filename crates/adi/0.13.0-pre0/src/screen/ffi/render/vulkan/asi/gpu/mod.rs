...
#[inline(always)]
pub(crate) unsafe fn vk_sym<T>(vk: VkInstance, lib: &VulkanApi, name: &[u8]) -> Result<T, String> {
    let fn_ptr = (lib.vkGetInstanceProcAddr)(vk, &name[0] as *const _ as *const i8);
...
pub(crate) unsafe fn sym<T>(vk: &GpuContext, name: &[u8]) -> Result<T, String> {
...
unsafe fn create_instance(
    ...
    let s2 = CString::new(if cfg!(target_os = "linux") {
        "VK_KHR_xcb_surface"
...
/// The Vulkan context.
pub static mut VULKAN: Option<Gpu> = None;

/// The Vulkan context.
#[derive(Clone)]
pub struct Gpu(Rc<RefCell<GpuContext>>);
...
pub(crate) struct GpuContext {
    ...
    // Vulkan C API.
    pub(crate) mapmem: unsafe extern "system" fn(
        VkDevice,
        VkDeviceMemory,
        VkDeviceSize,
        VkDeviceSize,
    ...
    pub(crate) new_swapchain: unsafe extern "system" fn(
        VkDevice,
        *const VkSwapchainCreateInfoKHR,
        *const c_void,
        *mut VkSwapchainKHR,
    ) -> VkResult,
    pub(crate) get_swapcount:
        unsafe extern "system" fn(VkDevice, VkSwapchainKHR, *mut u32, *mut VkImage) -> VkResult,
    pub(crate) create_fence:
        unsafe extern "system" fn(VkDevice, *const VkFenceCreateInfo, *const c_void, *mut VkFence)
            -> VkResult,
    pub(crate) begin_cmdbuff:
        unsafe extern "system" fn(VkCommandBuffer, *const VkCommandBufferBeginInfo) -> VkResult,
    pub(crate) pipeline_barrier: unsafe extern "system" fn(
        VkCommandBuffer,
        VkPipelineStage,
        VkPipelineStage,
        VkFlags,
    ...
    pub(crate) queue_submit:
        unsafe extern "system" fn(VkQueue, u32, *const VkSubmitInfo, VkFence) -> VkResult,
    pub(crate) wait_fence:
        unsafe extern "system" fn(VkDevice, u32, *const VkFence, VkBool32, u64) -> VkResult,
    pub(crate) reset_fence: unsafe extern "system" fn(VkDevice, u32, *const VkFence) -> VkResult,
    pub(crate) reset_cmdbuff: unsafe extern "system" fn(VkCommandBuffer, VkFlags),
    pub(crate) create_imgview: unsafe extern "system" fn(
        VkDevice,
        *const VkImageViewCreateInfo,
        *const c_void,
        *mut VkImageView,
    ) -> VkResult,
    pub(crate) get_memprops:
        unsafe extern "system" fn(VkPhysicalDevice, *mut VkPhysicalDeviceMemoryProperties) -> (),
    pub(crate) create_image:
        unsafe extern "system" fn(VkDevice, *const VkImageCreateInfo, *const c_void, *mut VkImage)
            -> VkResult,
    pub(crate) get_imgmemreq:
        unsafe extern "system" fn(VkDevice, VkImage, *mut VkMemoryRequirements) -> (),
    pub(crate) mem_allocate: unsafe extern "system" fn(
        VkDevice,
        *const VkMemoryAllocateInfo,
        *const c_void,
        *mut VkDeviceMemory,
    ) -> VkResult,
    pub(crate) bind_imgmem:
        unsafe extern "system" fn(VkDevice, VkImage, VkDeviceMemory, VkDeviceSize) -> VkResult,
    pub(crate) new_renderpass: unsafe extern "system" fn(
        VkDevice,
        *const VkRenderPassCreateInfo,
        *const c_void,
        *mut VkRenderPass,
    ) -> VkResult,
    pub(crate) create_framebuffer: unsafe extern "system" fn(
        VkDevice,
        *const VkFramebufferCreateInfo,
        *const c_void,
        *mut VkFramebuffer,
    ) -> VkResult,
    pub(crate) drop_framebuffer:
        unsafe extern "system" fn(VkDevice, VkFramebuffer, *const c_void) -> (),
    pub(crate) drop_imgview: unsafe extern "system" fn(VkDevice, VkImageView, *const c_void) -> (),
    pub(crate) drop_renderpass:
        unsafe extern "system" fn(VkDevice, VkRenderPass, *const c_void) -> (),
    pub(crate) drop_image: unsafe extern "system" fn(VkDevice, VkImage, *const c_void) -> (),
    pub(crate) drop_buffer: unsafe extern "system" fn(VkDevice, VkBuffer, *const c_void) -> (),
    pub(crate) drop_memory:
        unsafe extern "system" fn(VkDevice, VkDeviceMemory, *const c_void) -> (),
    pub(crate) drop_swapchain:
        unsafe extern "system" fn(VkDevice, VkSwapchainKHR, *const c_void) -> (),
    pub(crate) update_descsets:
        unsafe extern "system" fn(VkDevice, u32, *const VkWriteDescriptorSet, u32, *const c_void)
            -> (),
    pub(crate) drop_descpool:
        unsafe extern "system" fn(VkDevice, VkDescriptorPool, *const c_void) -> (),
    pub(crate) bind_buffer_mem:
        unsafe extern "system" fn(VkDevice, VkBuffer, VkDeviceMemory, VkDeviceSize) -> VkResult,
    pub(crate) get_bufmemreq:
        unsafe extern "system" fn(VkDevice, VkBuffer, *mut VkMemoryRequirements) -> (),
    pub(crate) new_buffer: unsafe extern "system" fn(
        VkDevice,
        *const VkBufferCreateInfo,
        *const c_void,
        *mut VkBuffer,
    ) -> VkResult,
    pub(crate) new_descpool: unsafe extern "system" fn(
        VkDevice,
        *const VkDescriptorPoolCreateInfo,
        *const c_void,
        *mut VkDescriptorPool,
    ) -> VkResult,
    pub(crate) new_descsets: unsafe extern "system" fn(
        VkDevice,
        *const VkDescriptorSetAllocateInfo,
        *mut VkDescriptorSet,
    ) -> VkResult,
    pub(crate) new_shademod: unsafe extern "system" fn(
        VkDevice,
        *const VkShaderModuleCreateInfo,
        *const c_void,
        *mut VkShaderModule,
    ) -> VkResult,
    pub(crate) drop_shademod:
        unsafe extern "system" fn(VkDevice, VkShaderModule, *const c_void) -> (),
    pub(crate) new_pipeline: unsafe extern "system" fn(
        VkDevice,
        VkPipelineCache,
        u32,
    ...
    pub(crate) drop_pipeline: unsafe extern "system" fn(VkDevice, VkPipeline, *const c_void) -> (),
    pub(crate) new_pipeline_layout: unsafe extern "system" fn(
        VkDevice,
        *const VkPipelineLayoutCreateInfo,
        *const c_void,
        *mut VkPipelineLayout,
    ) -> VkResult,
    pub(crate) drop_pipeline_layout:
        unsafe extern "system" fn(VkDevice, VkPipelineLayout, *const c_void) -> (),
    pub(crate) new_descset_layout:
    ...
    pub(crate) bind_vb:
        unsafe extern "system" fn(VkCommandBuffer, u32, u32, *const VkBuffer, *const VkDeviceSize)
            -> (),
    pub(crate) bind_pipeline:
        unsafe extern "system" fn(VkCommandBuffer, VkPipelineBindPoint, VkPipeline) -> (),
    pub(crate) bind_descsets: unsafe extern "system" fn(
        VkCommandBuffer,
        VkPipelineBindPoint,
        VkPipelineLayout,
        u32,
    ...
    pub(crate) new_semaphore: unsafe extern "system" fn(
        VkDevice,
        *const VkSemaphoreCreateInfo,
        *const c_void,
        *mut VkSemaphore,
    ) -> VkResult,
    pub(crate) drop_semaphore:
        unsafe extern "system" fn(VkDevice, VkSemaphore, *const c_void) -> (),
    pub(crate) get_next_image:
        unsafe extern "system" fn(VkDevice, VkSwapchainKHR, u64, VkSemaphore, VkFence, *mut u32)
            -> VkResult,
    pub(crate) copy_image: unsafe extern "system" fn(
        VkCommandBuffer,
        VkImage,
        VkImageLayout,
        VkImage,
    ...
    pub(crate) subres_layout: unsafe extern "system" fn(
        VkDevice,
        VkImage,
        *const VkImageSubresource,
        *mut VkSubresourceLayout,
    ) -> (),
    pub(crate) get_surface_capabilities:
        unsafe extern "system" fn(VkPhysicalDevice, VkSurfaceKHR, *mut VkSurfaceCapabilitiesKHR)
            -> VkResult,
    pub(crate) begin_render:
        unsafe extern "system" fn(VkCommandBuffer, *const VkRenderPassBeginInfo, VkSubpassContents)
            -> (),
    pub(crate) set_viewport:
        unsafe extern "system" fn(VkCommandBuffer, u32, u32, *const VkViewport) -> (),
    pub(crate) set_scissor:
...
impl Gpu {
    ...
    pub(crate) fn new(rgb: Vector) -> Result<(Gpu, ::screen::ffi::Window), String> {
        unsafe {
            // Load the Vulkan library
            let api = VulkanApi::new()?;

            let vk = create_instance(vk_sym(mem::zeroed(), &api, b"vkCreateInstance\0")?);

            // Create Surface
            let window = ::screen::ffi::Window::new(None);
            let surface = surface::new(vk, &api, &window);
            let (gpu, pqi, sampled, format) = device::get_gpu(vk, &api, surface)?;
            let device = device::create_device(vk, &api, gpu, pqi);
            // Null swapchain.
            let swapchain = 0;
            // Device's loader
            let vkdsym: unsafe extern "system" fn(VkDevice, *const i8) -> *mut c_void =
                vk_sym(vk, &api, b"vkGetDeviceProcAddr\0")?;
            // Create present queue.
            let present_queue = queue::new((device, vkdsym), pqi)?;
            // Create command buffer.
            let (command_buffer, command_pool) = command_pool::new((device, vkdsym), pqi)?;
            ...
            let gpu = Gpu(Rc::new(RefCell::new(GpuContext {
                projection: matrix!(),
                vk,
                surface,
                gpu,
                ...
                get_memprops: vk_sym(vk, &api, b"vkGetPhysicalDeviceMemoryProperties\0")?,
                create_image: vkd_sym(device, vkdsym, b"vkCreateImage\0")?,
                get_imgmemreq: vk_sym(vk, &api, b"vkGetImageMemoryRequirements\0")?,
                ...
                get_bufmemreq: vk_sym(vk, &api, b"vkGetBufferMemoryRequirements\0")?,
                ...
                new_pipeline_layout: vkd_sym(device, vkdsym, b"vkCreatePipelineLayout\0")?,
                drop_pipeline_layout: vk_sym(vk, &api, b"vkDestroyPipelineLayout\0")?,
                new_descset_layout: vkd_sym(device, vkdsym, b"vkCreateDescriptorSetLayout\0")?,
                drop_descset_layout: vk_sym(vk, &api, b"vkDestroyDescriptorSetLayout\0")?,
                ...
                subres_layout: vkd_sym(device, vkdsym, b"vkGetImageSubresourceLayout\0")?,
                get_surface_capabilities: vk_sym(
                    vk,
                    &api,
    ...
    /// Set projection.
    pub(crate) fn projection_set(&self, mat: Matrix) {
        self.get_mut().projection = mat;
    }

    /// Get projection.
    pub(crate) fn projection_get(&self) -> Matrix {
        let connection = self.get();
