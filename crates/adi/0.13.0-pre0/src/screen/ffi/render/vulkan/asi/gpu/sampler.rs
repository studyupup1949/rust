...
pub(super) unsafe fn new(
    ...
    type VkCreateSampler =
        extern "system" fn(VkDevice, *const VkSamplerCreateInfo, *const c_void, *mut VkSampler)
            -> VkResult;
    let new_sampler: VkCreateSampler = gpu::vkd_sym(vkd.0, vkd.1, b"vkCreateSampler\0")?;
