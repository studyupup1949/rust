...
pub(crate) struct Context {
    ...
    pub(crate) snd_pcm_hw_params_get_period_size:
        unsafe extern "C" fn(
    ...
    pub(crate) snd_pcm_hw_params_get_rate:
        unsafe extern "C" fn(params: *const snd_pcm_hw_params_t, val: *mut c_uint, dir: *mut c_int)
            -> c_int,
    ...
    pub(crate) snd_pcm_hw_params_set_channels:
        unsafe extern "C" fn(pcm: *mut snd_pcm_t, params: *mut snd_pcm_hw_params_t, val: c_uint)
            -> c_int,
    pub(crate) snd_pcm_hw_params_any:
        unsafe extern "C" fn(pcm: *mut snd_pcm_t, params: *mut snd_pcm_hw_params_t) -> c_int,
    pub(crate) snd_pcm_writei:
        unsafe extern "C" fn(pcm: *mut snd_pcm_t, buffer: *const c_void, size: c_ulong)
            -> snd_pcm_sframes_t,
    pub(crate) snd_pcm_readi:
        unsafe extern "C" fn(pcm: *mut snd_pcm_t, buffer: *mut c_void, size: c_ulong)
            -> snd_pcm_sframes_t,
