...
use std::io::Write;
use std::ptr;
use footile::path::FillRule;
use footile::imgbuf::{accumulate_non_zero, accumulate_odd};
...
impl Mask {
    ...
    // TODO: move to examples as a separate module.
    ...
    /// Get the grayscale pixels for the mask.
    pub fn get_pixels<'a>(&'a self) -> &'a [u8] {
        &self.pixels[..]
    }
}
