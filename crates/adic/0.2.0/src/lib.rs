...
//! assert_eq!("...2312314._5", radic!(5, [4], [1, 3, 2]).to_string());
//! ```
//!
...
//!   e.g. [`UAdic`] for natural numbers, [`RAdic`] for (most) rationals, [`ZAdic`] for approximate numbers
...
pub use h_lift::{nth_root, variety_to_digits, roots_of_unity};
pub use num_adic::{AdicInteger, RAdic, UAdic, ZAdic, ZAdicValuation};
