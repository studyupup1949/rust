...
/// assert_eq!("...232341._5", RAdic::new(5, vec![1, 4], vec![3, 2]).to_string());
...
impl fmt::Display for RAdic {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        ...
        let digits = {
            let fix_iter = self.fix_d.iter();
            let rep_iter = self.rep_d.iter().cycle().take(self.rep_d.len() * 2);

            fix_iter.chain(rep_iter).join("").chars().rev().collect::<String>()
        };
...
mod tests {
    ...
    fn test_display() {
        ...
        assert_eq!("...44._5", neg_one().to_string());
        assert_eq!("...443._5", neg_two().to_string());
        assert_eq!("...442._5", neg_three().to_string());
        assert_eq!("...441._5", neg_four().to_string());
        assert_eq!("...440._5", neg_five().to_string());
        assert_eq!("...4430._5", neg_ten().to_string());
        assert_eq!("...11._5", neg_1_4().to_string());
        assert_eq!("...334._5", pos_1_4().to_string());
        assert_eq!("...110._5", neg_5_4().to_string());
        assert_eq!("...1132._5", pos_43_4().to_string());
        assert_eq!("...0101._5", neg_1_24().to_string());
        assert_eq!("...1010._5", neg_5_24().to_string());
        assert_eq!("...004004._5", neg_1_31().to_string());
        assert_eq!("...0404._5", neg_one_sixth().to_string());
    }
