...
//!
//! ```
//! # use adic::{iadic_neg, qadic, radic, uadic, zadic_approx, AdicInteger};
...
pub use adic_error::AdicError;
pub use num_adic::{
    AdicInteger, AdicSign, IAdic, LazyIntDiv, LazyQDiv, RAdic, SignedAdicInteger,
    UAdic, QAdic, QAdicValuation, ZAdic, ZAdicValuation
};
pub use poly_adic::{
    nth_root, polynomial_variety, roots_of_unity,
    AdicPolynomial, ZAdicVariety,
};
