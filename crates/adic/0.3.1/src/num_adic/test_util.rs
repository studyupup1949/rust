...
use crate::{
    iadic_neg, iadic_pos, qadic, radic, uadic, zadic_approx, zadic_exact_neg, zadic_exact_pos,
};
use super::{AdicInteger, IAdic, QAdic, RAdic, UAdic, ZAdic};
...
pub (crate) mod z {
    ...
    // Exact numbers
    pub fn zero_e() -> ZAdic { zadic_exact_pos!(5, []) }
    pub fn one_e() -> ZAdic { zadic_exact_pos!(5, [1]) }
    pub fn two_e() -> ZAdic { zadic_exact_pos!(5, [2]) }
    pub fn three_e() -> ZAdic { zadic_exact_pos!(5, [3]) }
    pub fn four_e() -> ZAdic { zadic_exact_pos!(5, [4]) }
    pub fn five_e() -> ZAdic { zadic_exact_pos!(5, [0, 1]) }
    pub fn six_e() -> ZAdic { zadic_exact_pos!(5, [1, 1]) }
    pub fn eight_e() -> ZAdic { zadic_exact_pos!(5, [3, 1]) }
    pub fn ten_e() -> ZAdic { zadic_exact_pos!(5, [0, 2]) }
    pub fn twenty_five_e() -> ZAdic { zadic_exact_pos!(5, [0, 0, 1]) }
    pub fn neg_one_e() -> ZAdic { zadic_exact_neg!(5, []) }
    pub fn neg_two_e() -> ZAdic { zadic_exact_neg!(5, [3]) }
    pub fn neg_five_e() -> ZAdic { zadic_exact_neg!(5, [0]) }
