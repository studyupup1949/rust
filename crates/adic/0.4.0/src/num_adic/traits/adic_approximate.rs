...
pub trait AdicApproximate: HasDigits {
    ...
    ///
    /// ```
    /// # use adic::{qadic, zadic_approx, zadic_exact_pos, AdicApproximate, AdicValuation};
    /// assert_eq!(AdicValuation::Finite(6), zadic_approx!(5, 6, [0, 3, 1, 2]).certainty());
    /// assert_eq!(AdicValuation::PosInf, zadic_exact_pos!(5, [0, 3, 1, 2]).certainty());
    ...
    /// assert_eq!(AdicValuation::PosInf, qadic!(zadic_exact_pos!(5, [0, 3, 1, 2]), -2).certainty());
    /// ```
    ...
    ///
    /// ```
    /// # use adic::{qadic, zadic_approx, zadic_exact_pos, AdicApproximate, AdicNumber, AdicValuation, ZAdic};
    ...
    ///
    /// ```
    /// # use adic::{qadic, zadic_approx, zadic_exact_pos, AdicApproximate};
    /// assert!(zadic_exact_pos!(5, [2, 3, 1, 2, 3, 1]).is_certain());
    /// assert!(!zadic_approx!(5, 6, [2, 3, 1, 2, 3, 1]).is_certain());
    /// assert!(qadic!(zadic_exact_pos!(5, [2, 3, 1, 2, 3, 1]), -2).is_certain());
