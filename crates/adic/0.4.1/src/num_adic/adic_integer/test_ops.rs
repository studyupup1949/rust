...
use crate::{
    iadic_neg, iadic_pos, radic, uadic, zadic_approx,
    AdicError, AdicInteger, AdicNumber,
};
use super::{IAdic, RAdic, UAdic};

use crate::num_adic::test_util::{i, r, u};
...
fn div_r_adic() {
    ...
    assert_eq!(Ok(-r::neg_1_6().into_approximation(4)), (r::neg_5_24() / r::neg_5_4()).zapprox(4));
