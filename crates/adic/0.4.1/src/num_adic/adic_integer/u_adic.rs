...
impl UAdic {
    ...
    /// Pop digit off the end of the number; truncates if zero
    ...
    ///
    /// ```
    /// # use adic::{uadic, AdicInteger, AdicNumber, UAdic};
...
mod tests {
    ...
    use super::{AdicInteger, AdicNumber, UAdic};
    ...
    fn u_adic_norm() {
        ...
        assert_eq!(AdicValuation::Finite(0), two().valuation());
        assert_eq!(Ratio::new(1, 1), two().norm());
        assert_eq!(AdicValuation::Finite(1), five().valuation());
        assert_eq!(Ratio::new(1, 5), five().norm());
        assert_eq!(AdicValuation::Finite(0), six().valuation());
        assert_eq!(Ratio::new(1, 1), six().norm());
        assert_eq!(AdicValuation::Finite(2), twenty_five().valuation());
        assert_eq!(Ratio::new(1, 25), twenty_five().norm());
        assert_eq!(AdicValuation::Finite(3), one_twenty_five().valuation());
        assert_eq!(Ratio::new(1, 125), one_twenty_five().norm());
        assert_eq!(AdicValuation::Finite(0), one_twenty_six().valuation());
