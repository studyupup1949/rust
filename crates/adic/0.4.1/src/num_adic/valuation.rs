...
///
/// ```
/// # use adic::{qadic, uadic, zadic_approx, AdicApproximate, AdicSized, AdicValuation, ZAdic};
...
/// assert_eq!(AdicValuation::PosInf, uadic!(5, []).valuation());
/// assert_eq!(AdicValuation::PosInf, uadic!(5, []).certainty());
