...
//!     qso["CAll"] = "AB3ABC"; // Change callsign
//!
...
//!     ]);
//!     assert_eq!("Chris", qso["name"]);  // Accessed field name with lower case
//!     assert_eq!("DK5XXX", qso["caLL"]);  // Accessed field name with mixed case
//!     doc.add_record(qso);
//!
//!     // Serialize and write
