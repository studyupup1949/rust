...
impl OrchestratorAgentBuilder {
    ...
    pub async fn build(self) -> Result<OrchestratorAgent> {
        ...
        // Build the LlmAgent with all tools and 0.5.0 resilience features
        let mut builder = LlmAgentBuilder::new("orchestrator-agent")
            ...
            // 0.5.0: per-tool execution timeout (5 min for pipeline/build tools)
            .tool_timeout(Duration::from_secs(300))
            // 0.5.0: auto-retry transient tool failures
