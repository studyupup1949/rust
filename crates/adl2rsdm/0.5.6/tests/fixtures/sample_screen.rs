// AUTO-GENERATED from sample.adl by adl2rsdm -- do not edit by hand.
...
/// RsDM screen generated from `sample.adl`.
pub struct Screen {
    _engine: Engine,
    alarm2: Channel,
    w3: RsdmLabel,
    ...
    w6: RsdmEnumComboBox,
    w7: RsdmSlider,
    w8: RsdmByteIndicator,
    w9: RsdmScaleIndicator,
    w10: RsdmDrawing,
    gate11: Channel,
    w12: RsdmDrawing,
    w13: RsdmDrawing,
...
impl Screen {
    ...
    pub fn new_in(
        ...
        let alarm2 = engine
            ...
            .expect("adl2rsdm: connect alarm-colour source ca://DMM1:status");
        let w3 = RsdmLabel::new(&engine, "ca://DMM1:readback")
            .expect("adl2rsdm: connect ca://DMM1:readback (text update)")
            .with_border_mode(BorderMode::DisconnectedOnly)
            .with_precision(3);
        let w4 = RsdmLineEdit::new(&engine, "ca://DMM1:setpoint")
            .expect("adl2rsdm: connect ca://DMM1:setpoint")
            .with_border_mode(BorderMode::DisconnectedOnly)
            .with_alignment(TextAlign::Center);
        let w5 = RsdmPushButton::new(&engine, "ca://DMM1:go", "Start", "1")
            .expect("adl2rsdm: connect ca://DMM1:go (message button)")
            .with_border_mode(BorderMode::DisconnectedOnly)
            .with_release_value("0");
        let w6 = RsdmEnumComboBox::new(&engine, "ca://DMM1:mode")
            .expect("adl2rsdm: connect ca://DMM1:mode (menu)")
            .with_border_mode(BorderMode::DisconnectedOnly)
            .with_alignment(TextAlign::Center);
        let w7 = RsdmSlider::new(&engine, "ca://DMM1:level")
            .expect("adl2rsdm: connect ca://DMM1:level (valuator)")
            .with_border_mode(BorderMode::DisconnectedOnly)
            .with_alarm_sensitive_content(false)
            .with_limits(0.0, 100.0)
            .with_precision(2);
        let w8 = RsdmByteIndicator::new(&engine, "ca://DMM1:bits")
            .expect("adl2rsdm: connect ca://DMM1:bits (byte)")
            .with_border_mode(BorderMode::DisconnectedOnly)
            .with_num_bits(8)
            .with_show_labels(false)
            .with_orientation(Orientation::Horizontal);
        let w9 = RsdmScaleIndicator::new(&engine, "ca://DMM1:fill")
            .expect("adl2rsdm: connect ca://DMM1:fill (scale indicator)")
            .with_border_mode(BorderMode::DisconnectedOnly)
            .with_bar_indicator(true);
        let w10 = RsdmDrawing::new(&engine, "ca://DMM1:show_box", DrawingShape::Rectangle)
            .expect("adl2rsdm: connect ca://DMM1:show_box (drawing)")
        ...
        let gate11 = engine
            .connect("calc://adl2rsdm_vis_149?dialect=medm&expr=A#0&A=ca://DMM1:show_box&update=A")
            .expect("adl2rsdm: connect visibility gate calc://adl2rsdm_vis_149?dialect=medm&expr=A#0&A=ca://DMM1:show_box&update=A");
        let w12 = RsdmDrawing::new(&engine, "loc://adl2rsdm_shape_0", DrawingShape::Ellipse)
        ...
        let w13 = RsdmDrawing::new(&engine, "loc://adl2rsdm_shape_1", DrawingShape::Arc { begin_deg: 0.0, span_deg: 90.0 })
            ...
            .with_size(egui::Vec2::new(60.0, 60.0))
            .with_placeholder_channel();
        let w14 = RsdmImage::new("logo.gif")
            .with_size(egui::Vec2::new(80.0, 24.0));
        let mut w15 = RsdmTimePlot::new(rs, __plot_base).with_time_span(60.0).with_title("Readback Trend").with_x_label("Time (s)").with_y_label("Volts").with_axis_color(Color32::from_rgb(0, 0, 0)).with_background_color(Color32::from_rgb(255, 255, 255));
        w15.add_channel(&engine, "ca://DMM1:readback", Color32::from_rgb(0, 0, 255), "DMM1:readback").expect("adl2rsdm: add strip-chart curve DMM1:readback");
        let mut w16 = RsdmWaveformPlot::new(rs, __plot_base + 1).with_title("Waveform").with_x_label("Index").with_y_label("Counts").with_x_range(0.0, 100.0).with_y_range(-5.0, 5.0).with_axis_color(Color32::from_rgb(0, 0, 0)).with_background_color(Color32::from_rgb(255, 255, 255));
        w16.add_xy_channel(&engine, "ca://DMM1:ywave", Some("ca://DMM1:xwave"), Color32::from_rgb(255, 0, 0), "curve 1").expect("adl2rsdm: add waveform curve 1");
        let w17 = RsdmFrame::new(&engine, "loc://adl2rsdm_frame_2")
            .expect("adl2rsdm: connect loc://adl2rsdm_frame_2 (composite)")
            .with_placeholder_channel();
        let w18 = RsdmLabel::new(&engine, "ca://DMM1:status")
            .expect("adl2rsdm: connect ca://DMM1:status (text update)")
            .with_border_mode(BorderMode::DisconnectedOnly);
