...
// (extracting the query string, path params, and — later — authenticated
// claims) and hand it to Resource methods.

use std::collections::HashMap;

/// Authenticated principal, populated by an adapter's auth layer (future work).
