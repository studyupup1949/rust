...
pub use attach::{attachments, set_attachments, Attachment, Attachments, FileField, UploadedFile};
pub use audit::{auditor, set_auditor, AuditEntry, Auditor, Event as AuditEvent};
...
pub use search::{indexer, set_indexer, Indexer};
...
pub mod prelude {
    ...
    pub use crate::attach::{set_attachments, Attachment, Attachments, FileField, UploadedFile};
    pub use crate::audit::{set_auditor, AuditEntry, Auditor};
    ...
    pub use crate::search::{set_indexer, Indexer};
