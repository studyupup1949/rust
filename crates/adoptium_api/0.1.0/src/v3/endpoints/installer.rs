...
api_request! {
    ...
    ///
    /// <https://api.adoptium.net/q/swagger-ui/#/Installer/getInstaller>
    struct Latest {
        endpoint: "/v3/installer/latest/{feature_version}/{release_type}/{os}/{arch}/{image_type}/{jvm_impl}/{heap_size}/{vendor}",
...
api_request! {
    ...
    /// Redirects to the installer that matches your current query
    ///
    /// <https://api.adoptium.net/q/swagger-ui/#/Installer/getInstallerByVersion>
    struct Version {
        endpoint: "/v3/installer/version/{release_name}/{os}/{arch}/{image_type}/{jvm_impl}/{heap_size}/{vendor}",
...
mod tests {
    ...
    fn latest_url_without_query() {
        ...
        let expected = url::Url::parse(&format!("{base}/v3/installer/latest/8/ga/linux/x64/jdk/hotspot/normal/eclipse", base = ApiBase::production()))
    ...
    fn latest_url_with_query() {
        ...
        let mut expected = url::Url::parse(&format!("{base}/v3/installer/latest/8/ea/linux/x64/jdk/hotspot/normal/eclipse", base = ApiBase::production()))
            .expect("Failed to create expected value");
    ...
    fn version_url_without_query() {
        ...
        let expected = url::Url::parse(&format!("{base}/v3/installer/version/8/linux/x64/jdk/hotspot/normal/eclipse", base = ApiBase::production()))
            .expect("Failed to create expected value");
    ...
    fn version_url_with_query() {
        ...
        let mut expected = url::Url::parse(&format!("{base}/v3/installer/version/8/linux/x64/jdk/hotspot/normal/eclipse", base = ApiBase::production()))
            .expect("Failed to create expected value");
