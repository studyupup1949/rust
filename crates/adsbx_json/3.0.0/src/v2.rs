...
impl DatabaseFlags {
    const MILITARY: u32 = 0b1;
    const INTERESTING: u32 = 0b10;
    const PIA: u32 = 0b100;
    const LADD: u32 = 0b1000;
...
mod tests {
        ...
        assert_eq!(
            ...
            Response {
                ...
                aircraft: vec![Aircraft {
                    acas_ra_csvline: None,
                    acas_ra_mv_mb_bytes_hex: None,
                    acas_ra_timestamp: None,
                    adsb_version: Some(2),
    ...
    fn test_parse_with_acas() {
        let input = r#"
        {
            "ac": [
                {
                    "acas_ra_csvline": "2021-03-28,20:14:53.2, adb3b1,DF:,  ,bytes:,E2C20008250227,  26.191040, -80.246110, 1000,ft,-1088,fpm,ARA:,1100001,RAT:,0,MTE:,0,RAC:,0000,          , RA: Climb,",
                    "acas_ra_mv_mb_bytes_hex": "E2C20008250227",
                    "acas_ra_timestamp": 1616962493.26,
                    "alert": 0,
                    "alt_baro": 1000,
                    "alt_geom": 1100,
                    "category": "A2",
        ...
        assert_eq!(aircraft.acas_ra_csvline.unwrap(), "2021-03-28,20:14:53.2, adb3b1,DF:,  ,bytes:,E2C20008250227,  26.191040, -80.246110, 1000,ft,-1088,fpm,ARA:,1100001,RAT:,0,MTE:,0,RAC:,0000,          , RA: Climb,");
        assert_eq!(aircraft.acas_ra_mv_mb_bytes_hex.unwrap(), "E2C20008250227");
        assert_eq!(
            aircraft.acas_ra_timestamp.unwrap(),
            "2021-03-28T20:14:53.260Z".parse::<DateTime<Utc>>().unwrap()
        );
    }
}
