...
//!
//! ```
//! use adsbx_screenshot::{AdsbxBrowser, AdsbxOptions};
//!
//! # fn main() -> Result<(), Box<dyn std::error::Error>> {
//! let config = AdsbxOptions {
...
impl AdsbxBrowser {
    ...
    pub fn screenshot(&mut self, options: &AdsbxOptions) -> Result<Screenshot, Error> {
