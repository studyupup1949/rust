...
use syn::{
    ...
    Generics, Path, Token, Type, Result, 
...
impl Parse for ImplVectorAddArg {
    fn parse(input: ParseStream) -> Result<Self> {
        let lhs_tys_content;
        let rhs_tys_content;
        let mut output = ImplVectorAddArg {
...
pub struct ImplVectorAdd {
    pub args: Punctuated<FullArg<ImplVectorAddArg>, Token![;]>
}
impl Parse for ImplVectorAdd {
    fn parse(input: ParseStream) -> Result<Self> {
        Ok(Self {
