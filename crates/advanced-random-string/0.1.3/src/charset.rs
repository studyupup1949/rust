...
pub const HEXADECIMAL: &[u8] = b"0123456789ABCDEFabcdef";
pub const ALPHABETIC: &[u8] = b"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz";
...
pub const ASCII_PRINTABLE: &[u8] = b" !\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~";
pub const URLSAFE_BASE64: &[u8] =
    b"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_";
pub const BINARY: &[u8] = b"01";
pub const OCTAL: &[u8] = b"01234567";
pub const SYMBOLS: &[u8] = b"!\"#$%&'()*+,-./:;<=>?@[\\]^_`{|}~";
pub const WHITESPACE: &[u8] = b" \t\n\r\x0b\x0c";
pub const EXTENDED_ASCII: &[u8] = &[
