...
use morphism::source_to_space_morphism;
...
pub(crate) fn hg_id(value: &str) -> AdvisoryResult<Id> {
    Id::new(value).map_err(higher_error)
}

pub(crate) fn higher_error(
    error: higher_graphen_core::CoreError,
) -> advisorygraphen_core::AdvisoryError {
