...
fn resolve_encoding(label: &str) -> Option<&'static encoding_rs2::Encoding> {
    match label {
        // Fast path for default cases
        "utf-8" | "UTF-8" => Some(encoding_rs2::UTF_8),
        "windows-1252" | "cp1252" | "iso-8859-1" | "latin1" => Some(encoding_rs2::WINDOWS_1252),

        // Common aliases
        "shift_jis" | "shift-jis" | "sjis" => Some(encoding_rs2::SHIFT_JIS),
        "big5" => Some(encoding_rs2::BIG5),
        "gbk" | "gb18030" => Some(encoding_rs2::GBK),
        "euc-kr" | "euckr" => Some(encoding_rs2::EUC_KR),
        "iso-2022-jp" => Some(encoding_rs2::ISO_2022_JP),
        "windows-1251" => Some(encoding_rs2::WINDOWS_1251),
        "windows-1250" => Some(encoding_rs2::WINDOWS_1250),
        "iso-8859-2" => Some(encoding_rs2::ISO_8859_2),
        "iso-8859-5" => Some(encoding_rs2::ISO_8859_5),
        "iso-8859-6" => Some(encoding_rs2::ISO_8859_6),
        "iso-8859-7" => Some(encoding_rs2::ISO_8859_7),
        "iso-8859-8" => Some(encoding_rs2::ISO_8859_8),
        "euc-jp" | "eucjp" => Some(encoding_rs2::EUC_JP),

        // Fallback to dynamic lookup
        _ => encoding_rs2::Encoding::for_label(label.as_bytes()),
    }
}
